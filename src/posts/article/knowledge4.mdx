---
title: "From Beads to Bytes: How the Abacus led to Apple!"
created: 2024-05-11
---
...
A couple of days back I wrote about how early humans used different tools for recording and storing information—cave arts, the wooden tablet, and the coming of writing and how did they use it for accounting purposes—that made me curious..
...
Inspired by the design of Abacus, Charles Babbage conceptualised the Difference Engine in 1822, and later went on to conceptualise the Analytical Engine, which led him to be called as the father of computer! (But he was not able to build any of the two)
